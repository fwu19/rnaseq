...
```{r}
if (exists('ms')){
  v <- unlist(strsplit('Sample,fastqc.total_sequences,fastqc_trimmed.total_sequences,star.uniquely_mapped,star.uniquely_mapped_percent,Genes.Detected,Exonic.Rate,Intronic.Rate,Intergenic.Rate,PCT_OFF_BAIT,ZERO_CVG_TARGETS_PCT', split = ','))
