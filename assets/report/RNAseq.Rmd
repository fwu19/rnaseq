...
params:
  dat.dir: "/fh/fast/_SR/Genomics/user/fwu/project/dmacpherson/20241010_LH00740_0009_A22VGKMLT3/hg38"
---
...
dst.dir <- 'macpherson_lab/20241010_LH00740_0009_A22VGKMLT3/Analysis/hg38'
...
cmp <- tribble(
  ...
  mutate(
    ...
    out.prefix = paste0(out.dir, '/', tg, '_vs_', cg, '/', tg, '_vs_', cg),
...
## DE rerun
differential_expression.r input=samples.csv comparison=comparisons.rds count.dir=counts gene.txt=gencode.v38.annotation.proteinCoding_lncRNA.genes.txt length.col=full_exome strand=0 fdr=0.05 fc=1.5 fdr2=0.01 fc2=2
...
## hg38
src=/hpc/temp/_SR/Genomics/users/fwu/dmacpherson/20241010_LH00740_0009_A22VGKMLT3/Analysis/
subdir=hg38
rsync -va --chown=solexa:$dstgroup --chmod=775 $subdir/241010_RNAseq.html $dst/$subdir/
rsync -vAXEWHhrLog --chown=solexa:$dstgroup --chmod=775 --no-compress --progress --exclude-from=to_exclude.txt $src/$subdir/ $dst/$subdir/ | tee -a $log
...
subdir=mm10
rsync -va --chown=solexa:$dstgroup --chmod=775 $subdir/241010_RNAseq.html $dst/$subdir/
subdir=mm10/differential_expression
rsync -vAXEWHhrLog --chown=solexa:$dstgroup --chmod=775 --no-compress --progress --exclude-from=to_exclude.txt $src/$subdir/ $dst/$subdir/ | tee -a $log
